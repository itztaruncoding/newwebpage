...
const AlertDialogOverlay = React.forwardRef(({
  className,
  ...props
}, ref) => <AlertDialogPrimitive.Overlay className={cn('fixed inset-0 z-50 bg-blue-950/70 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0', className)} {...props} ref={ref} />);
